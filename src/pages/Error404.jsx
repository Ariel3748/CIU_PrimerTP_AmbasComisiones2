        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-6 text-center text-md-start">
            ...
            <div className="lc-block mb-3">
              <div>
                <h1 className="display-1 fw-bold text-dark">Error 404</h1>
              </div>
            </div>
            ...
            <div className="lc-block mb-5">
              <div>
                <p className="fs-5 fw-light text-muted">
                  El estante virtual o la página que estás buscando fue movida,
                  removida o nunca existió en nuestra biblioteca.
                </p>
              </div>
            </div>
            ...
            <div className="lc-block">
              <Link
                className="btn btn-lg btn-dark fw-bold px-4"
                to="/"
                role="button"
              >
                Volver al Inicio 🏠
